Rails.application.routes.draw do
  ...
  delete "issue_tta_report/unlink_report/:issue_id_tta",
    to: "issue_tta_reports#unlink", as: :unlink_tta_report
  resources :issue_monitoring_reviews, only: [:create, :update]
  delete "issue_monitoring_review/unlink_revoew/:issue_id_monitoring",
    to: "issue_monitoring_reviews#unlink", as: :unlink_monitoring_review
